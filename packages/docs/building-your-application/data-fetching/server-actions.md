...
- `X-Action`: This header returns the id of the action that generated the stream. This information is crucial for the client to understand the context of the stream, especially when multiple nested actions are involved, to rerender the correct component.
