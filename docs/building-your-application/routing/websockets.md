...
next:
  text: "Component details - server components"
  link: "02-building-your-application/02-component-details/01-server-components.md"
---
...
> [!TIP]
>
> You have access to the `ServerWebSocket` from any server-component, middleware, API route, etc. Since it is inside the [`RequestContext`](/docs/building-your-application/data-fetching/request-context).
