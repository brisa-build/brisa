...
- `reactivity`: The next document will be rendered using reactivity. It only changes the parts of the page that have changed, preserving Web Component states.
